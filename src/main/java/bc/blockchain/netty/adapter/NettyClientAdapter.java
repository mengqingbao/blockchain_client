...
public class NettyClientAdapter extends ChannelInboundHandlerAdapter {
	...
	public NettyClientAdapter(BlockChainContext blockChainContext) {
	...
	public void channelRead(ChannelHandlerContext ctx, Object msg)
		...
		Response response= DispatherUtil.getInstance(new SimpleServerCallBack(blockChainContext,req)).doService(req);
		write(response,ctx);
	}
